...
export function SleepLifestyleCard({
  ...
  return (
    <motion.div
      ...
      className="w-full"
    >
      <Card className="glass-card border-2 border-orange-500/30 bg-gradient-to-br from-navy-800/80 to-navy-900/90 hover:border-orange-400/50 transition-all duration-300 overflow-hidden">
        ...
        <CardContent className="pt-0">
          <div className="space-y-6">
            ...
            <div className="px-6 py-8 bg-gradient-to-br from-orange-900/30 to-red-900/20 rounded-2xl border-2 border-orange-500/40 shadow-2xl backdrop-blur-sm">
              {/* Instructions */}
