...
export function SleepEnvironmentCard({
  ...
  return (
    <motion.div
      ...
      className="w-full"
    >
      <Card className="glass-card border-2 border-navy-500/30 bg-gradient-to-br from-navy-800/80 to-navy-900/90 hover:border-navy-400/50 transition-all duration-300">
            ...
            <div className="flex items-center justify-center">
              <div className="flex gap-2">
                {Array.from({ length: max - min + 1 }).map((_, index) => {
                  const isActive = index < (value - min + 1);
                  return (
                    <div
                      key={index}
