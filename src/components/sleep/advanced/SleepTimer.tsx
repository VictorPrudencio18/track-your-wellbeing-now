    ...
    <Card className="glass-card-holographic border-navy-600/30 overflow-hidden">
      ...
      <CardHeader className="relative z-10">
        <CardTitle className="text-white flex items-center gap-3">
          ...
          Timer de Sono
          <Badge variant="outline" className="ml-auto border-navy-400/50 text-navy-100">
      ...
      <CardContent className="relative z-10 space-y-6">
        ...
        <div className="text-center">
          ...
          {isActive && (
            ...
            >
              {getPhaseIcon()}
              <span className="capitalize">Fase {phase}</span>
              {isPaused && (
        ...
        {isActive && (
          ...
          >
            ...
            <div className="text-center p-3 bg-navy-800/30 rounded-xl border border-navy-600/20">
              <Volume2 className="w-4 h-4 text-blue-400 mx-auto mb-1" />
              <div className="text-sm font-semibold text-white">23dB</div>
              <div className="text-xs text-gray-400">Ruído</div>
            </div>
            
            <div className="text-center p-3 bg-navy-800/30 rounded-xl border border-navy-600/20">
              <Timer className="w-4 h-4 text-purple-400 mx-auto mb-1" />
              <div className="text-sm font-semibold text-white">{Math.floor(seconds / 60)}</div>
        ...
        {!isActive && (
          ...
          >
            ...
            <p className="text-xs mt-1">Dados serão salvos no seu perfil</p>
          </motion.div>
        )}
      </CardContent>
    </Card>
