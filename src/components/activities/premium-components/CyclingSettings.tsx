...
interface CyclingSettingsProps {
  isOpen: boolean;
  onClose: () => void;
  autoLap: number;
  onAutoLapChange: (value: number) => void;
  screenMode: 'metrics' | 'map' | 'split';
  onScreenModeChange: (mode: 'metrics' | 'map' | 'split') => void;
}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <Slider
                      value={[autoLap]}
                      onValueChange={(values) => onAutoLapChange(values[0])}
                      max={10}
                      min={0.5}
                      step={0.5}
                      className="w-full"
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => onScreenModeChange(mode.id as any)}
                        className={`glass-card border-navy-600 ${
                          screenMode === mode.id 
